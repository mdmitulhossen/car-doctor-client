            ...
            <div className="carDoctorContainer pb-10 mt-10">
                <div className="flex gap-10">
                    ...
                    <div className="w-full md:w-1/2 border xl:p-16 lg:p-10 p-5 rounded-md">
                        <p className="text-3xl font-semibold w-full text-center">Login</p>
                        ...
                        <form className="mt-10">                           
                            ...
                            <button className="px-4 py-2 text-sm font-semibold rounded-md w-full text-white bg-[#FF3811] hover:bg-[#d35036] duration-200 mt-5">Sign In</button>
                        </form>
                        <p className="w-full text-center font-semibold mt-5">Or Sign In with</p>
                        ...
                        <p onClick={()=>navigate('/signup')} className="w-full text-center font-medium mt-5">
                           haven't an account? <span className="text-[#FF3811] cursor-pointer">Sign Up</span>
                        </p>
